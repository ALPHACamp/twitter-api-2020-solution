...
// app.get('/api/users/:id', authenticated, function (req, res) {
...
//   })
// })
app.post('/api/users/:id', authenticated, function (req, res) {
  // console.log('\n\n* 更新自己的介紹')
...
app.get('/admin/signin', (req, res) => res.render('signin'))
...
app.get('/api/admin/users', authenticated, function (req, res) {

  if(helpers.getUser(req).role !== 'admin')
    return res.json({status: 'error'})

  return User.findAll({include: [Tweet, {model: User, as: 'Followers'}]}).then(users => {
...
app.delete('/api/admin/tweets/:id', authenticated, function (req, res) {
...
app.post('/api/followships', authenticated, function (req, res) {
...
app.delete('/api/followships/:id', authenticated, function (req, res) {

  return Followship.destroy({where: {
    followerId: helpers.getUser(req).id, 
    followingId: req.params.id
  }}).then((followship) => {
    return res.json({})
...
app.post('/api/tweets/:id/like', authenticated, function (req, res) {
...
app.post('/api/tweets/:id/unlike', authenticated, function (req, res) {

  return Like.destroy({where: {
    UserId: helpers.getUser(req).id, 
    TweetId: req.params.id
  }}).then(() => {
    return res.json({})
...
app.post('/api/tweets/:tweet_id/replies', authenticated, function (req, res) {
  if(!req.body.comment){
    return res.send('error')
  }
...
app.get('/api/tweets/:tweet_id/replies', authenticated, function (req, res) {
  return Reply.findAll({where: {TweetId: req.params.tweet_id}}).then(replies => {
    return res.json(replies)
  })
})

app.post('/api/tweets', authenticated, function (req, res) {
  Tweet.create({
    description: req.body.description,
    UserId: helpers.getUser(req).id,
  }).then(() => {
...
app.get('/api/tweets', authenticated, function (req, res) {
  return Tweet.findAll().then(tweets => {
    return res.json(tweets)
  })
})

app.get('/api/tweets/:id', authenticated, function (req, res) {
  return Tweet.findByPk(req.params.id).then(tweets => {
    return res.json(tweets)
  })
})
...
app.get('/api/users/:id/tweets', authenticated, function (req, res) {
  // console.log(`\n\n* ${helpers.getUser(req).id} 編輯 ${req.params.id} 的介紹`)
...
app.get('/api/users/:id/replied_tweets', authenticated, function (req, res) {
  // console.log(`\n\n* ${helpers.getUser(req).id} 編輯 ${req.params.id} 的介紹`)
  return User.findByPk(req.params.id, {include: [ Reply
  ]}).then(user => {
    return res.json(user.Replies)
  })
})

app.get('/api/users/:id/likes', authenticated, function (req, res) {
  // console.log(`\n\n* ${helpers.getUser(req).id} 編輯 ${req.params.id} 的介紹`)
  return User.findByPk(req.params.id, {include: [ Like
  ]}).then(user => {
    return res.json(user.Likes)
  })
})

app.get('/api/users/:id/followings', authenticated, function (req, res) {
  // console.log(`\n\n* ${helpers.getUser(req).id} 編輯 ${req.params.id} 的介紹`)
  return Followship.findAll({where: {followerId: req.params.id}}).then(followings => {
    return res.json(followings)
  })
})

app.get('/api/users/:id/followers', authenticated, function (req, res) {
  // console.log(`\n\n* ${helpers.getUser(req).id} 編輯 ${req.params.id} 的介紹`)
  return Followship.findAll({where: {followingId: req.params.id}}).then(followers => {
    return res.json(followers)
  })
})

app.put('/api/users/:id', authenticated, function (req, res) {
  // console.log(`\n\n* ${helpers.getUser(req).id} 編輯 ${req.params.id} 的介紹`)
  return User.findByPk(req.params.id)
    .then((user) => {
      user.update({
